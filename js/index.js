window.addEventListener("load", function(){
	...
	function SlideShow_pack(_targetWrap, _intervalTime, _view_ea_D, _view_ea_T, _view_ea_M, _type){
		...
		(function init(){
			if(_type == "fade"){
				console.log($inner_ul_li[0].scrollHeight);
		...
		if(_type == "slide"){
			...
			let pos_Initial;
			let pos_Final;
			let threshold = $view_mask.offsetWidth / 2;
	...
	let SlideShow_pack_01 = SlideShow_pack(".visual", 4000, 1, 1, 1, "slide");
	let SlideShow_pack_02 = SlideShow_pack(".collection", 4000, 1, 1, 1, "slide");
